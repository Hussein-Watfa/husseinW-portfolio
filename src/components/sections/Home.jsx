      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-500 to-pink-400 bg-clip-text text-transparent leading-right">
            Hi, I'm Hussein Watfa
          </h1>

          <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I'm a UMass Boston student with a 3.9 GPA in Computer Science. I have a strong passion for Software Development, IT, and Data Science.
          </p>
